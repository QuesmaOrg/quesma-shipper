module github.com/QuesmaOrg/quesma-shipper
...
// gopkg.in/yaml.v3 is unmaintained (go-yaml/yaml archived April 2025); go.yaml.in/yaml/v3 is
// the YAML org's continuation of the same code. Pinned to v3.0.5 because cobra already requires
