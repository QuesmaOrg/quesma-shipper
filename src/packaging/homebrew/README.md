...
Caskroom installations never apply TUF self-updates or remove their own payloads. Brew upgrades stop
the old service and register the new version; uninstall stops it and preserves all local state.
...
and do not defer updates to Brew. No new signing credentials or cross-repository token is required.
