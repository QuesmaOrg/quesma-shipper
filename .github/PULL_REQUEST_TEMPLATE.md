...
- Does a Fleet Manager deployment template grant anything new, or does
  `fleet-manager/src/terraform_test.go` change? If yes, what may the runtime identity or a reader
  now do?
